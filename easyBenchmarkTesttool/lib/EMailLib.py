...
to_mail_addr="yangjun03@baidu.com,linqiaoying@baidu.com,yangjun03@baidu.com",server="mail2-in.baidu.com",img_description_list=[u"QPS(query per second)曲线:",u"CPU_IDLE曲线(努力支持中...)",u"内存占用曲线(努力支持中...)"],
